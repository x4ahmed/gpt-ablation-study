...
REM Architecture ablation: identity gate (1 + 0.25*tanh, starts at ~1)
...
echo.
echo Running Architecture ablation: Identity Gate...
echo.
python arch_ablations/train.py ^
  --run-name arch_identity_gate ^

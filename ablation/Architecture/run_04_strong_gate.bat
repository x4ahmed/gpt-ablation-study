...
REM Architecture ablation: strong gate (2*sigmoid, starts near 1, can suppress/amplify)
...
echo.
echo Running Architecture ablation: Strong Gate...
echo.
python arch_ablations/train.py ^
  --run-name arch_strong_gate ^

...
parser = argparse.ArgumentParser(description="Train GPT model (Muon optimizer)")
...
if _has_triton:
    _compile_fn = torch.compile(dynamic=False, fullgraph=True)
else:
    _compile_fn = lambda fn: fn
